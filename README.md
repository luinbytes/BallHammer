...
- Outlines and nameplates for priority enemies
- Dynamic boxes and counts for hordes
- Configurable aimbot, magnet triggerbot, and rage mode
- Distance, field-of-view, smoothing, and activation settings
